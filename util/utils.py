...
class DiagGaussian(nn.Module):
    ...
    #use to sample contiunes action
...
def ppo_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=500,
        help="number of forward steps (default: 500)",
    )
    parser.add_argument(
        "--num-processes",
        type=int,
    ...
    parser.add_argument(
        "--log-file", type=str, default="log", help="path for log file"
    )
    parser.add_argument(
        "--reward-window-size",
        type=int,
    ...
    parser.add_argument(
        "--flow-checkpoint-folder",
        type=str,
        default="flow_data/flow_ckpt",
        help="folder for storing flow checkpoints",
    )
    parser.add_argument(
        "--gpu-id",
        type=int,
